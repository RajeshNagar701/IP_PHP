...
client computer storing some 

information regarding the client computer, so that when the same page 
from the server is visited by the user, 
...
setcookie('user',"Raj Nagar cookie",time()+15);   // CREATE  365*24*60*60
